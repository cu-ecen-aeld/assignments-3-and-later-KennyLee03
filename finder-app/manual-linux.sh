...
CROSS_COMPILER_DIR=$(aarch64-none-linux-gnu-gcc -print-sysroot)
cp -L ${CROSS_COMPILER_DIR}/lib/ld-linux-aarch64.so.1 ${OUTDIR}/rootfs/lib/
cp -L ${CROSS_COMPILER_DIR}/lib64/libm.so.6 ${OUTDIR}/rootfs/lib64/
cp -L ${CROSS_COMPILER_DIR}/lib64/libc.so.6 ${OUTDIR}/rootfs/lib64/
cp -L ${CROSS_COMPILER_DIR}/lib64/libresolv.so.2 ${OUTDIR}/rootfs/lib64/
